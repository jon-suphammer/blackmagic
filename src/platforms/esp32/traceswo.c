...
// This task receives serial data over the SWO pin, and prints on serial output 
static void swoTask(void *inpar) {
//        rxPin = 1;
//        txPin = 3;
  unsigned char* data;
...
void traceswo_init() {
    ...
    xTaskCreate(&swoTask, "swo_thread", 4*4096, NULL, 8, NULL);
